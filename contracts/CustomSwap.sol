...
/**
 * @title CustomSwap - A Custom StableSwap implementation in solidity.
 ...
 * deployment size.
 */
contract CustomSwapPool is OwnerPausable, ReentrancyGuard {
    ...
    function swap(
        ...
        returns (uint256)
    {
        // require(msg.sender == gatewayAddr, "SWAP: ACCESS DENIED");
    ...
    function setGatewayAddr(address _gatewayAddr) external onlyOwner {
        gatewayAddr = _gatewayAddr;
    }
